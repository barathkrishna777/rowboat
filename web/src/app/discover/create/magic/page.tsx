  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-[var(--text-muted)] mb-6">
        Phase 1 scaffold: this page will turn natural language into a structured preset in a later phase.
      </p>
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 text-[var(--text-muted)]">
        Coming next: text prompt input, AI parse preview, and editable options.
      </div>
    </div>
  );
}
